    ...
    public class VoiceConfig
    {
        ...
        public void initDefault()
        {
            ...
            propVoiceList.Add(new PropVoiceInfo(new string[] { "手袋つける" }, null,
                new MaskInfo[] { new MaskInfo("glope", "true") }));
            propVoiceList.Add(new PropVoiceInfo(new string[] { "手袋外す" }, null,
                new MaskInfo[] { new MaskInfo("glope", "false") }));
            ...
            addYotogiList("止める", new string[] { "やめる", "やめるよ", "抜くよ", "止まって" },
            ...
            addYotogiList("丁寧に奉仕して頂く", new string[] { "丁寧に奉仕してください", "丁寧に奉仕します" });
            addYotogiList("丁寧に咥えさせる", new string[] { "丁寧に咥えて", "丁寧にしゃぶって" });
            addYotogiList("丁寧に舐めさせてもらう", new string[] { "丁寧に舐めさせて", "丁寧に舐めるよ" });
            addYotogiList("丁寧に舐めさせて頂く", new string[] { "丁寧に舐めさせてください", "丁寧に舐めます" });
            addYotogiList("丁寧に舐める", new string[] { "丁寧に舐めるよ", "じっくり舐めるよ" });
            //行為
            addYotogiList("咥えさせる", new string[] { "咥えて", "しゃぶって" });
            ...
            addYotogiList("胸を揉む", new string[] { "胸を揉む", "胸揉むよ", "おっぱい揉むよ", "胸触るよ" });
            addYotogiList("胸揉み", new string[] { "胸を揉む", "胸揉むよ", "おっぱい揉むよ", "胸触るよ" });
            ...
            addYotogiList("胸を揉まれたことを指摘する", new string[] { "揉まれたね", "揉まれちゃったね" });
            addYotogiList("胸を揉む＆尻穴を弄る", new string[] { "", "胸と尻を弄る", "胸とアナルを弄る" });
            addYotogiList("胸を揉むのを見せつける", new string[] { "胸を揉む" });
            addYotogiList("胸を揉んでビッチにする", new string[] { "胸を揉む", "胸でビッチになって" });
            addYotogiList("胸を揉んで気持ち良くさせる", new string[] { "気持ちよくなって", "胸で気持ちよくなって" });
            addYotogiList("胸を揉んで見せつける", new string[] { "胸を揉む", "胸を見せつけて", "おっぱい見せつけて" });
            addYotogiList("胸を揉んで自分に夢中にさせる", new string[] { "夢中にさせる", "夢中になって" });
            addYotogiList("胸洗いをさせる", new string[] { "胸で洗って", "おっぱいで洗って" });
            addYotogiList("まずは胸に触る", new string[] { "胸触るよ", "おっぱい触るよ" });
            addYotogiList("尻コキ", new string[] { "尻コキして", "お尻でして", "お尻でこすって" });
            addYotogiList("尻を叩いていただく", new string[] { "尻を叩いてください" });
            addYotogiList("尻を叩かせながら", new string[] { "尻を叩かせる" });
            addYotogiList("尻を叩きながら", new string[] { "尻を叩く", "お尻を叩くよ", "叩くよ" });
            addYotogiList("尻を叩く", new string[] { "尻を叩く", "尻を叩かせる" });
            addYotogiList("尻を撫でる", new string[] { "お尻撫でるよ" });
            addYotogiList("尻を舐める", new string[] { "お尻舐めるよ" });
            addYotogiList("尻穴セックス&前穴愛撫", new string[] { "", "尻と前を責める", "前後を責める", "両穴を責める" });
            addYotogiList("尻穴を責めさせながら", new string[] { "尻穴責めて", "アナル責めて" });
            addYotogiList("尻穴を責めながら", new string[] { "尻穴責めるよ", "アナル責めるよ", "お尻弄るよ", "アナル弄るよ" });
            addYotogiList("尻穴を責める", new string[] { "尻穴責めるよ", "アナル責めるよ", "お尻弄るよ", "アナル弄るよ" });
            addYotogiList("尻穴を弄りながら", new string[] { "尻穴弄るよ", "お尻弄るよ", "アナル弄るよ" });
            addYotogiList("尻穴を弄る", new string[] { "尻穴弄るよ", "お尻弄るよ", "アナル弄るよ" });
            addYotogiList("尻穴弄り", new string[] { "尻穴弄るよ", "お尻弄るよ", "アナル弄るよ" });
            ...
            addYotogiList("クンニする", new string[] { "クンニするよ", "クンニするよ", "舐める", "舐めるよ" });
            addYotogiList("手コキ", new string[] { "手コキして", "手でして", "手でこすって" });
            addYotogiList("手コキしながら咥える", new string[] { "手コキしながら咥えて", "こすりながらしゃぶって" });
            addYotogiList("手コキでイカせてもらう", new string[] { "手コキで行かせて", "手で行かせて" });
            addYotogiList("手コキでイカせる", new string[] { "手コキで行かせて", "手で行かせて" });
            ...
            //絶頂
            addYotogiList("イカさせて頂く", new string[] { "行かせてください", "行かせていただきます" });
            addYotogiList("イカせる", new string[] { "行け", "行って", "行っちゃえ" });
            addYotogiList("イってもらう", new string[] { "行ってください", "行って" });
            addYotogiList("イって頂く", new string[] { "行ってください", "行って" });
            addYotogiList("絶頂", new string[] { "絶頂して", "行け", "行って", "行っちゃえ" });
            addYotogiList("絶頂&射精", new string[] { "一緒に行くよ", "一緒に行って" });
            addYotogiList("絶頂させる", new string[] { "絶頂して", "行け", "行って", "行っちゃえ" });
            addYotogiList("絶頂焦らし", new string[] { "焦らす", "行かせない", "行っちゃダメ" });
            addYotogiList("潮吹き絶頂", new string[] { "潮吹いて", "潮吹いて行って" });
            addYotogiList("連続絶頂", new string[] { "イきまくって", "イきまくれ", "何度も行って", "何度も行かせる" });
            addYotogiList("連続絶頂告白", new string[] { "どうだった？" });
            addYotogiList("射精", new string[] { "射精するよ", "出すよ", "出すぞ", "出るよ" });
            addYotogiList("射精させてもらう", new string[] { "射精させて", "出させて", "行かせて" });
            addYotogiList("射精させて頂く", new string[] { "射精させてください", "出させてください", "行かせてください" });
            ...
            addYotogiList("中出し", new string[] { "中出しするよ", "中に出す", "中に出すよ" });
            addYotogiList("中出し&口内射精", new string[] { "", "中と口に出す", "同時に出すぞ", "同時に出すよ" });
            addYotogiList("中出し＆絶頂", new string[] { "", "中に出す", "中に出すよ", "中で一緒に", "一緒に行って" });
            addYotogiList("中出しおねだり", new string[] { "中出しおねだりして", "中におねだりして", "中に欲しい？" });
            addYotogiList("中出しさせて頂く", new string[] { "中出しさせてください", "中出しします" });
            addYotogiList("中出しさせる", new string[] { "中出しするよ", "中に出す", "中に出すよ", "中に出すぞ" });
            addYotogiList("中出しする", new string[] { "中出しするよ", "中に出す", "中に出すよ", "中に出すぞ" });
            addYotogiList("中出し感想", new string[] { "中出しどうだった？" });
            addYotogiList("膣内に注ぎ込む", new string[] { "奥に出す", "奥に出すよ", "奥にそそぐ", "子宮に出すよ" });
            ...
            addYotogiList("尻穴に注ぎ込む", new string[] { "注ぎ込む", "しりに出す", "おしりに出すよ" });
            addYotogiList("連続尻穴射精", new string[] { "しりに出す", "おしりに出すよ" });
            addYotogiList("顔にかける", new string[] { "顔に出すよ", "顔にかけるよ", "ぶっかける" });
            addYotogiList("顔にぶっかけ", new string[] { "顔に出すよ", "顔にかけるよ", "ぶっかける" });
            addYotogiList("顔に掛ける", new string[] { "顔に出すよ", "顔にかけるよ", "ぶっかける" });
            addYotogiList("顔に出す", new string[] { "顔に出すよ", "顔にかけるよ", "ぶっかける" });
            addYotogiList("顔に出す２", new string[] { "同時に出すよ", "同時にかけるよ" });
            addYotogiList("顔射", new string[] { "顔に出すよ", "顔にかけるよ", "ぶっかける" });
            addYotogiList("顔射&絶頂", new string[] { "", "顔射で行って", "かけられながら行って" });
            addYotogiList("顔射２", new string[] { "そっちの顔に出すよ", "そっちにかけるよ" });
            addYotogiList("顔射させて頂く", new string[] { "顔射させてください", "顔射します", "顔に出させてください" });
            addYotogiList("顔射させる", new string[] { "顔に出すよ", "顔にかけるよ", "ぶっかける" });
            addYotogiList("顔射する", new string[] { "顔に出すよ", "顔にかけるよ", "ぶっかける" });
            ...
            addYotogiList("外出しさせる", new string[] { "", "そと出しさせる", "そと出しする", "外に出す", "外に出すよ", "ぶっかける" });
            addYotogiList("外出しする", new string[] { "", "そと出しする", "外に出す", "外に出すよ", "ぶっかける" });
            addYotogiList("口に出す", new string[] { "口に出すよ" });
            addYotogiList("口に出す２", new string[] { "こっちも出すよ" });
            addYotogiList("口内に射精させて頂く", new string[] { "口に出させてください" });
            addYotogiList("口内射精", new string[] { "口に出す", "口に出すよ" });
            addYotogiList("口内射精&絶頂", new string[] { "", "口と一緒に行って", "一緒に行って" });
            addYotogiList("口内射精２", new string[] { "そっちに出すよ", "そっちの口に出すよ" });
            ...
            addYotogiList("『アナルセックスの感想を聞かせて』", new string[] { "感想を聞かせて", "どんな気持ち？" });
            ...
            addYotogiList("『セックスの感想を聞かせて』", new string[] { "感想を聞かせて", "どんな気持ち？" });
            ...
            addYotogiList("『誰のセックスが一番気持ちいい？』", new string[] { "誰が一番気持ちいい？" });
            ...
            addYotogiList("Aに壷洗いさせる", new string[] { "ツボ洗いして", "あそこで洗って" });
            ...
            addYotogiList("Aを絶頂させる", new string[] { "絶頂させる", "行って" });
            ...
            addYotogiList("Bをクンニでイカせる", new string[] { "クンニで行って" });
            addYotogiList("Bを強く責める", new string[] { "そっちも強くするよ" });
            addYotogiList("Bを責める", new string[] { "そっちも責めるよ" });
            addYotogiList("Bを絶頂させる", new string[] { "そっちも行って" });
            ...
            addYotogiList("お客様にセックスの実況を聞かせる", new string[] { "セックスの実況を聞かせる", "実況を聞かせて" });
            ...
            addYotogiList("お客様に奉仕させる", new string[] { "お客様に奉仕して" });
            ...
            addYotogiList("お尻の穴を弄りながら", new string[] { "尻穴弄るよ", "お尻弄るよ", "アナル弄るよ" });
            ...
            addYotogiList("バイブ挿入+連続寸止め懇願", new string[] { "連続寸止め", "行かせてほしい？" });
            addYotogiList("ハメ撮り告白撮影", new string[] { "ハメ撮りするよ", "どんな気分？" });
            ...
            addYotogiList("ペニスをしごいて射精させる", new string[] { "しごいて射精させて", "しごいて行かせて" });
            ...
            addYotogiList("メイドが自分の胸を揉みながら", new string[] { "胸揉んで", "おっぱい揉んで", "自分で胸揉んで" });
            ...
            addYotogiList("ラブバイブでイカせる", new string[] { "バイブで行って", "行って" });
            ...
            addYotogiList("淫語実況", new string[] { "実況して", "淫乱に実況して" });
            ...
            addYotogiList("最奥を擦らせる", new string[] { "奥をこすって", "一番奥をこすって" });
            addYotogiList("最奥を責めながら", new string[] { "奥を責めるよ", "奥責めるよ", "奥にするよ" });
            addYotogiList("最奥を責める", new string[] { "一番奥を責めて", "奥を責めて" });
            addYotogiList("最奥責め", new string[] { "奥を責めるよ", "奥責めるよ", "奥にするよ" });
            addYotogiList("撮影しながら", new string[] { "撮るよ", "ハメ撮りするよ" });
            addYotogiList("撮影する", new string[] { "撮るよ", "ハメ撮りするよ" });
            addYotogiList("擦りつけさせて頂く", new string[] { "こすりつけさせてください", "こすりつけます" });
            addYotogiList("擦りつける", new string[] { "こすりつけるよ" });
            ...
            addYotogiList("自分で胸を揉みながら", new string[] { "胸を揉んで", "胸揉んで", "おっぱい揉んで", "自分で胸揉んで" });
            addYotogiList("自分で動く", new string[] { "自分で動いて", "こっちが動くよ" });
            addYotogiList("自分の胸を揉ませながら", new string[] { "胸を揉んで", "胸揉んで", "おっぱい揉んで", "自分で胸揉んで" });
            addYotogiList("自分の胸を揉みながら", new string[] { "胸を揉んで", "胸揉んで", "おっぱい揉んで", "自分で胸揉んで" });
            addYotogiList("自分の胸を揉みながら＆特殊愛撫", new string[] { "胸を揉んで", "胸揉んで", "おっぱい揉んで", "自分で胸揉んで" });
            ...
            addYotogiList("熟練した技術でたわし洗いをさせる", new string[] { "たわし洗いして", "下の毛で洗って" });
            ...
            addYotogiList("夫の目の前で胸を揉みながら", new string[] { "胸を揉む" });
            ...
            addYotogiList("放尿絶頂", new string[] { "おしっこして", "行きながら漏らして", "漏らして" });
            ...
            addYotogiList("両胸を揉みながら", new string[] { "両胸揉むよ", "おっぱい揉むよ" });
            addYotogiList("両胸を揉む", new string[] { "両胸揉んで", "おっぱい揉んで", "自分で揉んで" });
            ...
            addYotogiList("はるのに中出し", new string[] { "中出しする", "中に出す", "はるのの中に出す" });
            addYotogiList("はるのを絶頂させる", new string[] { "はるのも行って" });
            addYotogiList("千秋に外出しさせる", new string[] { "", "そと出しさせる" });
            addYotogiList("千秋に強く責めさせるA", new string[] { "強く責めさせる" });
            addYotogiList("千秋に止めさせる", new string[] { "止めさせる" });
            addYotogiList("千秋に責めさせるA", new string[] { "責めさせる" });
            addYotogiList("千秋に中出しさせる", new string[] { "中出しさせる" });
            addYotogiList("千秋に丁寧に奉仕させる", new string[] { "丁寧に奉仕させる" });
            ...
            addYotogiList("千里に中出し", new string[] { "中出しする", "中に出す", "千里の中に出す" });
            ...
            addYotogiList("美希に外出しさせる", new string[] { "", "そと出しする", "美希にぶっかける" });
            addYotogiList("美希に顔射", new string[] { "顔射する", "顔にかける", "美希にぶっかける" });
            addYotogiList("美希に顔射させる", new string[] { "顔射する", "顔にかける", "美希にぶっかける" });
            addYotogiList("美希に口内射精させる", new string[] { "口に出す", "美希の口に出す" });
            addYotogiList("美希に中出し", new string[] { "中出しする", "中に出す", "美希の中に出す" });
            addYotogiList("美希に中出しさせる", new string[] { "中出しする", "中に出す", "美希の中に出す" });
            addYotogiList("富彦に外出しさせる", new string[] { "", "そと出しさせる" });
            addYotogiList("富彦に強く責めさせるA", new string[] { "強く責めさせる" });
            addYotogiList("富彦に止めさせるA", new string[] { "止めさせる" });
            addYotogiList("富彦に責めさせるA", new string[] { "責めさせる" });
            addYotogiList("富彦に中出しさせる", new string[] { "中出しさせる" });
            ...
            addYotogiList("感想を聞くA", new string[] { "感想は？" });
            addYotogiList("感想を聞くB", new string[] { "そっちの感想は？" });
            ...
            addYotogiList("口に出す&バイブ絶頂", new string[] { "口とバイブで行って" });
            ...
            addYotogiList("尻コキさせる", new string[] { "尻コキして" });
            ...
            addYotogiList("絶頂放尿", new string[] { "行きながら漏らして" });
